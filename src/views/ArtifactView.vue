...
const deleteJob = async () => {
  try {
    ...
    if (confirm) {
      await axios.delete(`/api/artifacts/${jobId}`);
      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            <h3 class="text-lime-600 text-lg font-bold mb-6">
              Description
            </h3>
            ...
            <!-- <h3 class="text-lime-600 text-lg font-bold mb-2">Tags</h3> -->
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold mb-6">Authors Info</h3>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <RouterLink :to="`/artifacts/edit/${state.job.id}`"
