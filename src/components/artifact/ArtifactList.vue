...
<template>
  <section class="bg-green-50 px-4 py-10">
    <div class="container-xl lg:container m-auto">
      <h2 class="text-3xl font-bold text-stone-900 mb-6 text-center">Browse Artifacts</h2>
      ...
      <div class="mb-6">
        <div class="flex gap-2">
          ...
          <div class="flex flex-wrap gap-2">
            <label
              v-for="(tag, index) in artifactsStore.tags"
              :key="index"
            ...
            >
              ...
              />
              <span
                class="text-lg font-medium text-gray-700 hover:text-lime-600 transition duration-300"
              >
                {{ tag.tag }}
              </span>
            </label>
        ...
        <div class="flex flex-wrap gap-2">
          <span>Badges:</span>
          <label
            v-for="(badge, index) in state.badges"
            :key="index"
            class="flex items-center cursor-pointer"
          >
            <input
            ...
            />
            <span
              class="inline-flex text-lg font-medium text-gray-700 hover:text-lime-600 transition duration-300"
            >
